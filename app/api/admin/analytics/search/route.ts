...
import { getAnalyticsSearch, parseDateRangeParams } from "@/lib/analytics-api";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const search = await getAnalyticsSearch(token, parseDateRangeParams(request.nextUrl.searchParams));

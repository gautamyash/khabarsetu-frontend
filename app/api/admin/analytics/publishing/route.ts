...
import { getAnalyticsPublishing, parseDateRangeParams } from "@/lib/analytics-api";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const publishing = await getAnalyticsPublishing(token, parseDateRangeParams(request.nextUrl.searchParams));

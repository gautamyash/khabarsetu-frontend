...
import { getCategoryAnalytics, parseDateRangeParams } from "@/lib/analytics-api";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const categories = await getCategoryAnalytics(token, parseDateRangeParams(request.nextUrl.searchParams));

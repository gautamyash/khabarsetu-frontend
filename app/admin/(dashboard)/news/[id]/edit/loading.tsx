/** Shown automatically by Next.js while EditNewsPage's async data (auth
 * check, article fetch, categories fetch) is in flight — mirrors the
 * two-column news form shape so the layout doesn't jump. */
export default function EditNewsLoading() {
  return (
    <div>
      <div className="h-7 w-40 animate-pulse rounded-sm bg-ink-100" />
